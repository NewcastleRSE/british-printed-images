...
app.get('/api/image_subject_search/:item/:min/:max', db.getImagesBySubjectDate);
app.get('/api/image_subject_search_by_index/:item/:min/:max', db.getImagesBySubjectIndex);
